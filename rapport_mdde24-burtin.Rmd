...
Le résumé des valeurs de paramètres sont disponibles dans le tableau 1. Pour les covariables, les valeurs sont disponibles dans le tableau 2.
...
```{r Creation table des covariables, echo=FALSE, message=FALSE, warning=FALSE}
...
Ensuite, il s'en est suivi la définition des covariable avec leur distribution et valeurs moyennes :

-   Age : normal, 20.7 mois +/- 16

-   Poids : normal, 7.1 kg +/- 2.4

Pour le premier traitement, il fut repris la dose retenue par l'article à savoir 10 mg/kg et par jour, avec une durée de perfusion de 30min. La dose croit selon le poids, et l'intercept est de 0. Au départ un modèle sur 7 jour a été réalisé, mais pour plus de simplicité sur le rapport (et comme il n'est pas fait mention de durée totale sur l'article), on se basera en dose unique.
