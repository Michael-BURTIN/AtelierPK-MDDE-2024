...
On peut voir à partir de ce tableau, qu'en dehors du schéma à 10 mgkg de l'article, on ne dépasse jamais la cible basse. Le dosage 150 mg en dose unique ne fait pas mieux que celui de l'article et il faut donc regarder vers un nouveau schéma posologique.
