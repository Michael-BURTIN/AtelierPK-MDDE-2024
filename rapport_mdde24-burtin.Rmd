...
traitements = c("150 mg, dose unique", "10 mg/kg par jour")
...
resultats_cible = data.frame(traitements, atteinte_cible_basse, atteinte_cible_moyenne, atteinte_cible_haute) %>%
	...
	flextable
resultats_cible <- set_caption(resultats_cible, as_paragraph("Tableau 4 - Pourcentage d'atteninte de la cible"))
resultats_cible
