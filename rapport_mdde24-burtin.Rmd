...
Egalement voici la distribution au cours du temps des concentrations pour chacun des groupes à partir de Simulix. On peut observer que dès 5 heures dans chacun des groupes, la concentration redescend en dessous de 10 mg/l. Augmenter le dosage ne fera qu'augmenter le pic de concentration sur les premières heures et donc la toxicité. Il vaut mieux partir sur une administration plus régulière, mais inférieur à 150 mg où on atteinte déjà un pic bien supérieure à la moyenne haute.

![Figure 4 - Evoluion des concentrations au cours du temps pour chacun des schémas posologiques](models/Simulix Project/150mg_uniqueDose/ChartsFigures/Distribution de la Cmax sur les deux schémas posologique.png)

## Calcul de l'atteinte de la cible

Plusieurs essais de dosage, on ensuite été réalisé en variant la dose et la fréquence. L'objectif étant de ne pas trop sortir de la limite haute pour les outsiders afin d'éviter toutes surtoxicité. Mais également de garder la concentration moyenne sur une cible intermédiaire (à 16 mg/l), et bien entendu le plus rapprocher possible afin d'assurer un maximum d'efficacité sur l'infection. Ainsi, un dosage à 15 mg/kg toutes les 8 heures fût ce qui concilier au mieux tous ces aspects. La figure 5 ci dessous compare le traitement à 10 mg/kg par jour issu de l'article, et ma recommandation à 15 mg/kg toutes les 8 heures.

![Distribution au cours du temps de chacun des groupes de schéma posologique](models/Simulix Project/15mgk__8h_on_5days/ChartsFigures/predictiondistribution_Cc_0_0.png)
