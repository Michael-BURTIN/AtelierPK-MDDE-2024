...
Pour le moment, les données simulées comportant des valeurs manquantes, il n'est pas possible de poursuivre l’exécution du code sans erreur. Le reste du rapport décrira ce qui est attendu.
